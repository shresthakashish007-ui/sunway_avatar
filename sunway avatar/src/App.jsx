    ...
    const t1 = setTimeout(() => {
      ...
      speak("Namaste! Welcome to Sunway College Kathmandu. I am your AI admission assistant. How can I help you today?", {
        ...
        onEnd: () => {
          ...
          sendChat("welcome - just show the home panel and give 3-4 helpful suggestion pills, no long reply needed");
        },
      });
    }, 800);
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {transcript ? (
              ...
              <div style={{ fontSize: 11, color: "#4ade80", fontStyle: "italic" }}>Speak now — tap stop when done</div>
            )}
          </div>
        </div>
      )}
