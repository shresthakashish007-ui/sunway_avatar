...
Command: npx gltfjsx@6.5.3 public/models/namaste_girl.glb 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF('/namaste_girl.glb')
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature">
          ...
          <skinnedMesh name="Tongue_Mesh" geometry={nodes.Tongue_Mesh.geometry} material={materials['Teeth.001']} skeleton={nodes.Tongue_Mesh.skeleton} morphTargetDictionary={nodes.Tongue_Mesh.morphTargetDictionary} morphTargetInfluences={nodes.Tongue_Mesh.morphTargetInfluences} />
        </group>
      </group>
    </group>
  )
...
useGLTF.preload('/namaste_girl.glb')
